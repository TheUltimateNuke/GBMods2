...
- Install the mod by extracting the downloaded zip file to your Gang Beasts installation or installing via mod manager
- Run the game to the main menu, then close it to make sure config files are generated
